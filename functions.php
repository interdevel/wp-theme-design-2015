...
function ideas_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'ideas_custom_background_args', array(
...
function ideas_scripts() {
	wp_enqueue_style( 'ideas-style', get_stylesheet_uri() );

	wp_enqueue_script( 'ideas-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'ideas-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
